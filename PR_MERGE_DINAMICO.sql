create or replace NONEDITIONABLE PROCEDURE pr_merge_dinamico(p_tabla_update VARCHAR2, p_tabla_origen VARCHAR2) IS
/* -------------------------------------------------------------------------
    18-ABR-2024
    nestor.hernandez2009@gmail.com
    Construye la Instrucción Merge de forma dinamica para actualizar y/o sincronizar una tabla con respecto a otra.
    Parametros: tablaOrigen, Tabla Destino
...
BEGIN
    ...
    WHERE /* CONS.OWNER = 'NDHM' */
      CONS.TABLE_NAME = lvc_tabla_update
    ...
    -- Construír la sentencia MERGE Completa
    ----------------------------------------
